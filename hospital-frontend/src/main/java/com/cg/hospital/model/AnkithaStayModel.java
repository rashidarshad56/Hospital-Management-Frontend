...
public class AnkithaStayModel {
	 private int stayId;
	    private AnkithaPatientModel patient;
	    private int room;
		...
		public AnkithaPatientModel getPatient() {
			return patient;
		}
		public void setPatient(AnkithaPatientModel patient) {
